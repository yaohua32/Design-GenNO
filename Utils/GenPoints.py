...
class Point2D():
    ...
    def showPoint(self, point_dict:dict, title=''):
...
if __name__=='__main__':
    demo = Point2D()
    grid_scaled = demo.integral_grid(n_mesh_or_grid=20)
    xc, R = demo.weight_centers(n_center=500)
    demo.showPoint({'xc':xc.reshape(-1,2), 'grid_scaled':grid_scaled})