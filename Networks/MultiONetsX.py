...
#  */
# Note: out = (w_1*b_1 + ... + w_L * b_L)*t_L/L + b
...
class MultiONetBatch(nn.Module):
    ...
    def forward(self, x, a):
        ...
        a = self.fc_branch_in(a)
        ########
        for net_b in self.branch_net[:-self.l]:
            a = net_b(self.activation_branch(a))
        ########
        out = 0.
        for net_b, w in zip(self.branch_net[-self.l:], self.w):
            a = net_b(self.activation_branch(a))
